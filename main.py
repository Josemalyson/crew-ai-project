...
# Create agents that configure personas;
...
planner = Agent(
    ...
    """
        ...
        about the topic: {topic}. You collect information that helps the 
        audience learn something and make informed decisions. 
        Your work is the basis for the Content Writer to write 
...
writer = Agent(
    ...
    """
        ...
        about the topic: {topic}. You base your writing on the work of 
        the Content Planner, who provides an outline and relevant context about the topic. 
...
editor = Agent(
    ...
    """
        ...
        from the Content Writer. Your goal is to review the blog post 
...
result = crew.kickoff(inputs={"topic": blog_post})
